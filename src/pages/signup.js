    ...
    return (
        <div className="container flex mx-auto max-w-screen-md items-center h-screen">
            ...
            <div className="flex flex-col w-3/5 mx-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} method="submit" className="flex flex-col items-center bg-white p-4 border border-blue-600 mb-4 rounded">
                    ...
                    <button
                        ...
                        type="submit"
                        className="bg-blue-600 text-white rounded px-8 h-8 font-bold">
                        Sign Up
                    </button>
                </form>
                ...
                <div className="flex justify-center items-center flex-col w-full bg-white p-4 rounded border border-blue-600">
                    <p className="text-sm">
                        Tu as un compte ?{` `}
